                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{ !empty($adminData->photo) ? url('backend/upload/admin_images/' . $adminData->photo) : url('backend/upload/no_image.jpg') }}"
                                        alt="Admin" class="rounded-circle p-1 bg-primary" width="110" height="110">
                                    <div class="mt-3">
                                        <h4>{{ $adminData->name }}</h4>
                                        <p class="text-secondary mb-1">{{ $adminData->email }}</p>
                                        <p class="text-muted font-size-sm">{{ $adminData->company }}</p>
                                    </div>
                                </div>
                                <hr class="my-4" />
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="{{ route('admin.profile.store') }}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showImage"
                                                src="{{ !empty($adminData->photo) ? url('backend/upload/admin_images/' . $adminData->photo) : url('backend/upload/no_image.jpg') }}"
