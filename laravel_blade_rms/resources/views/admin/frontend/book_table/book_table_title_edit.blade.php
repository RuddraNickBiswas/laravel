                ...
                <div class="card border rounded">
                    ...
                    <div class="card-body">
                        <div class="p-4 border rounded">
                            <form method="POST" action="{{ route('fn.book_table_title.update', $bookTableTitle->id) }}"
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="title_first" type="text"
                                            ...
                                            name="title_first" value="{{ old('title_first', $bookTableTitle->title_first) }}"
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="title_last" type="text"
                                            ...
                                            value="{{ old('title_last', $bookTableTitle->title_last) }}" required
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea style="height: 100px" id="description" type="text"
                                            class="form-control @error('description') is-invalid @enderror" name="description" required autofocus>{{ old('description', $bookTableTitle->description) }}</textarea>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="visibility"
                                            ...
                                            required>
                                            <option value="1" {{ $bookTableTitle->visibility ? 'selected' : '' }}>
                                                {{ __('Visible') }}</option>
                                            <option value="0" {{ !$bookTableTitle->visibility ? 'selected' : '' }}>
                                                {{ __('Hidden') }}</option>
                                        </select>
