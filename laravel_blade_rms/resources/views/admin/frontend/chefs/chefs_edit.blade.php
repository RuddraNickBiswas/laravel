    ...
    <div class="m-4">
        <div class="row">
            <div class="col-md-12 mt-4">
                <h6 class="mb-0 text-uppercase">Chefs Edit Section</h6>
                <hr>
                <div class="card border rounded">
                    ...
                    <div class="card-body">
                        <div class="p-4 border rounded">
                            <form method="POST" action="{{ route('fn.chefs.update', $chef->id) }}"
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="name" type="text"
                                            ...
                                            value="{{ old('name', $chef->name) }}" required autocomplete="name" autofocus>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="post" type="text"
                                            ...
                                            value="{{ old('post', $chef->post) }}" required autocomplete="post" autofocus>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="twitter" type="text"
                                            ...
                                            value="{{ old('twitter', $chef->twitter) }}" required autocomplete="twitter"
                                            autofocus>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="facebook" type="text"
                                            ...
                                            value="{{ old('facebook', $chef->facebook) }}" required autocomplete="facebook"
                                            autofocus>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="instagram" type="text"
                                            ...
                                            value="{{ old('instagram', $chef->instagram) }}" required
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="linkedin" type="text"
                                            ...
                                            value="{{ old('linkedin', $chef->linkedin) }}" required autocomplete="linkedin"
                                            autofocus>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="visibility"
                                            ...
                                            required>
                                            <option value="1" {{ $chef->visibility ? 'selected' : '' }}>
                                                {{ __('Visible') }}</option>
                                            <option value="0" {{ !$chef->visibility ? 'selected' : '' }}>
                                                {{ __('Hidden') }}</option>
                                        </select>
