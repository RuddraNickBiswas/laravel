    ...
    <div class="m-4">
        <div class="row">
            <div class="col-md-12 mt-4">
                <h6 class="mb-0 text-uppercase"> Create Event </h6>
                <hr>
                <div class="card border rounded">
                    ...
                    <div class="card-body">
                        <div class="p-4 border rounded">
                            <form method="POST" action="{{ route('fn.event.store') }}"
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea style="height: 100px" id="description_top" type="text"
                                            class="form-control @error('description_top') is-invalid @enderror" name="description_top" required autofocus>{{ old('description_top') }}</textarea>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea style="height: 100px" id="description_bottom" type="text"
                                            ...
                                            autofocus>{{ old('description_bottom') }}</textarea>
