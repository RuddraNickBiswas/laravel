    ...
    <div class="m-4">
        <div class="row">
            <div class="col-md-12 mt-4">
                <h6 class="mb-0 text-uppercase">Edit Hero Section</h6>
                <hr>
                <div class="card border rounded">
                    ...
                    <div class="card-body">
                        <div class="p-4 border rounded">
                            <form method="POST" action="{{ route('fn.hero.update', $heroSection->id) }}"
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="title" type="text"
                                            ...
                                            value="{{ old('title', $heroSection->title) }}" required autocomplete="title"
                                            autofocus>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea style="height: 100px" id="description" type="text"
                                            ...
                                            {{ old('description', $heroSection->description) }}" required autocomplete="description" autofocus>{{ old('description', $heroSection->description) }}</textarea>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="visibility"
                                            ...
                                            required>
                                            <option value="1" {{ $heroSection->visibility ? 'selected' : '' }}>
                                                {{ __('Visible') }}</option>
                                            <option value="0" {{ !$heroSection->visibility ? 'selected' : '' }}>
                                                {{ __('Hidden') }}</option>
                                        </select>
