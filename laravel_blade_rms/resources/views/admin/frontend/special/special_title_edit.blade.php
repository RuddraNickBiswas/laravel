                ...
                <div class="card border rounded">
                    ...
                    <div class="card-body">
                        <div class="p-4 border rounded">
                            <form method="POST" action="{{ route('fn.special_title.update', $specialSectionTitle->id) }}"
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="title_first" type="text"
                                            ...
                                            name="title_first"
                                            value="{{ old('title_first', $specialSectionTitle->title_first) }}" required
                                            autocomplete="title_first" autofocus>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="title_last" type="text"
                                            ...
                                            value="{{ old('title_last', $specialSectionTitle->title_last) }}" required
        ...
        <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="visibility"
                                            ...
                                            required>
                                            <option value="1" {{ $specialSectionTitle->visibility ? 'selected' : '' }}>
                                                {{ __('Visible') }}</option>
                                            <option value="0" {{ !$specialSectionTitle->visibility ? 'selected' : '' }}>
                                                {{ __('Hidden') }}</option>
                                        </select>
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary">
                                        {{ __('Update Special Section Title') }}
                                    </button>
                                </div>
                        </div>
