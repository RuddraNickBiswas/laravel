    ...
    <div class="m-4">
        <div class="row">
            <div class="col-md-12 mt-4">
                <h6 class="mb-0 text-uppercase">Edit Special Section</h6>
                <hr>
                <div class="card border rounded">
                    ...
                    <div class="card-body">
                        <div class="p-4 border rounded">
                            <form method="POST" action="{{ route('fn.special.update',$specialSection->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="tab_name" type="text"
                                            ...
                                            value="{{ old('tab_name',$specialSection->tab_name) }}" required autocomplete="tab_name" autofocus>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="title" type="text"
                                            ...
                                            value="{{ old('title', $specialSection->title) }}" required autocomplete="title" autofocus>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="title_italic" type="text"
                                            ...
                                            name="title_italic" value="{{ old('title_italic', $specialSection->title_italic) }}" required
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea style="height: 100px" id="description" type="text"
                                            class="form-control @error('description') is-invalid @enderror" name="description" required autofocus>{{ old('description', $specialSection->description) }}</textarea>
...
<div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="visibility"
                                            ...
                                            required>
                                            <option value="1" {{ $specialSection->visibility ? 'selected' : '' }}>
                                                {{ __('Visible') }}</option>
                                            <option value="0" {{ !$specialSection->visibility ? 'selected' : '' }}>
                                                {{ __('Hidden') }}</option>
                                        </select>
